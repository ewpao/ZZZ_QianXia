        ...
        pass
        {
            ...
            HLSLPROGRAM
                ...
                half4 frag(Varyings i) : SV_TARGET
                {
                    ...
                    // 调色
                    color.rgb *= _ColourModulation;//颜色调节
                    
                    half luminance = dot(color.rgb, half3(0.299, 0.587, 0.114));//感知加权灰阶公式
                    color.rgb = lerp(luminance, color.rgb, _Saturation);//调节饱和度
